    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <h1>
                    <i class="glyphicon glyphicon-edit"></i> Activity /
                    @if($activity->id)
                        Edit #{{$activity->id}}
                    @else
                        Create
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="area" id="area-field" value="{{ old('area', $activity->area ) }}" />
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                	...
                	<textarea name="content" id="content-field" class="form-control" rows="3">{{ old('content', $activity->content ) }}</textarea>
                </div>
